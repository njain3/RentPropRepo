...
<title>RentProp-Dashboard</title>
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addApartmentServlet?flag=add" method="post" enctype="multipart/form-data" role="form">
					<input type="hidden" name="userType" value="resident">
					<input type="hidden" name="rental_status" value="available">
					<div class="form-group">
						<!-- <label class="col-sm-3 control-label" for="field-1">Apartment Photo</label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bedroom" Name="bedroom" class="form-control" required="required">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bathroom" Name="bathroom" class="form-control" required="required">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea placeholder="Enter Aminities" name="amenities" class="form-control" required="required"></textarea>
						</div>
					</div>
						...
						<div class="col-sm-5">
							<textarea placeholder="Enter address" name="address" class="form-control" required="required"></textarea>
						</div>
					</div>
						...
						<label class="col-sm-3 control-label" for="field-1">
							City*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter City" Name="city" class="form-control" required="required">
						</div></div>
						...
						<label class="col-sm-3 control-label" for="field-1">
							State*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter State" name="state" class="form-control" required="required">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Zip Code*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Zip Code" Name="zipCode" class="form-control" required="required">
						</div></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Enter rental price per month" name="price" class="form-control" required="required">
						</div>
					</div>
