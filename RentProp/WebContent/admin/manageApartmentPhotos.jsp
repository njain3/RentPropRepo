	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<tbody>
				<c:forEach items="${sessionScope.search_apartments_photos }" var="i">
					<tr class="odd gradeX">
						<td>${i.photoId }</td>
						<td>${i.fileName }</td>
						<td>${i.encryptedName }</td>
						<td>${i.apartmentDTO.apartmentId }</td>
						
						
						<td>
						 <a onclick="return confirmDelete()" href="<%=request.getContextPath()%>/apartmentPhotoServlet?flag=delete&photo_id=${i.photoId}">DELETE</a>
						</td>
