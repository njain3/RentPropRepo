	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<tbody>
				<c:forEach items="${sessionScope.list_of_all_request }" var="i">
					<tr class="odd gradeX">
						<td>${i.rentalRequestId }</td>
						<td>${i.firstName }</td>
						<td>${i.lastName }</td>
						<td>${i.emailId }</td>
						<td>${i.phoneNumber }</td>
						...
						<td>
						<a onclick="return confirmDelete()" href="<%=request.getContextPath()%>/addApartmentServlet?flag=delete_rental_request&rentalRequestId=${i.rentalRequestId}">
