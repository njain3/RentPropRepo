	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentServlet?flag=add" method="post" role="form">
					...
					<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id*</label>
						<div class="col-sm-5">
							<input type="email" placeholder="abc@gmail.com" name="emailId" class="form-control">
						</div></div>
						...
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="(xxx)xxxxxxx" name="phoneNo" class="form-control">
						</div></div>
						
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Rental Address*</label>
						<div class="col-sm-5">
						<select class="form-control" name="apartmentID">
							<option disabled="disabled">Select Apartment</option>
							<c:forEach items='${sessionScope.search_apartments_address1}' var="i">
								<option value="${i.apartmentId}">${i.address}, ${i.city }, ${i.state } - ${i.zipCode }</option>
							</c:forEach>
						</select>
						</div>
						</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Assign User Id*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter User Id" name="userId" class="form-control">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
