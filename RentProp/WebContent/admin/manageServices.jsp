			...
			<table class="table table-bordered datatable" id="table-1">
				...
				<c:forEach items="${sessionScope.search_services }" var="i">
					<tr class="odd gradeX">
						...
						<td>${i.residentDTO.residentId }</td>
						
						
						<td>
						<a href="<%=request.getContextPath()%>/maintenanceRequestServlet?flag=fetch&service_id=${i.serviceId }&resident_id=${i.residentDTO.residentId }">REPLY</a> 
						</td>
