...
<head>
	...
	<%
		...
		if (errorMsg != null) {
			out.print("<p style='background-color:red; font-size:16px; color:white'>" + errorMsg + "</p>");
		}		
	%>
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/apartmentPhotoServlet?flag=add" method="post" enctype="multipart/form-data" role="form">
					...
					<div class="form-group">
						...
						<option value="${i.apartmentId }">${i.address}, ${i.city }, ${i.state }</option>
						</c:forEach>
						</select>
						</div></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="file" name="file" required="required" > Upto 2 MB Only
						</div></div>
