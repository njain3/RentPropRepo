...
<%-- 				<c:forEach items="${sessionScope.edit_apartments }" var="x"> --%>
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addApartmentServlet?flag=update" method="post" role="form">
					<input type="hidden" value="${sessionScope.edit_apartments.apartmentId}" name="apartmentId"/>
					<input type="hidden" value="${sessionScope.edit_apartments.rentalStatus}" name="status"/>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">No. of Bedroom*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bedroom" Name="bedroom" class="form-control" value="${sessionScope.edit_apartments.noOfBedroom }">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">No. of Bathroom*</label>
						<div class="col-sm-5">
							<input type="text" placeholder="No. of Bathroom" Name="bathroom" class="form-control" value="${sessionScope.edit_apartments.noOfBathroom }">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Amenities*</label>
						<div class="col-sm-5">
							<textarea placeholder="Enter Aminities" name="amenities" class="form-control" >${sessionScope.edit_apartments.aminities }</textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Apartment Address</label>
						<div class="col-sm-5">
							<textarea placeholder="Enter address" name="address" class="form-control">${sessionScope.edit_apartments.address}</textarea>
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							City</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter City" Name="city" value="${sessionScope.edit_apartments.city }" class="form-control">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							State</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter State" name="state" value="${sessionScope.edit_apartments.state }" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Zip Code</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Zip Code" Name="zipCode" value="${sessionScope.edit_apartments.zipCode }" class="form-control">
						</div></div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Enter rental price per month" name="price" value="${sessionScope.edit_apartments.price }" class="form-control">
						</div>
					</div>
