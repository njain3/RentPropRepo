	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="panel-body">
				<c:forEach items="${sessionScope.edit_residents }" var="x">
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/addResidentServlet?flag=update" method="post" role="form">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							First Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter First Name" name="firstName" class="form-control" value="${x.loginDto.firstName}">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Last Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Last Name" name="lastName" class="form-control" value="${x.loginDto.lastName}">
						</div></div>
						<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id</label>
						<div class="col-sm-5">
							<input type="email" placeholder="abc@gmail.com" name="emailId" class="form-control" value="${x.loginDto.emailId}">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.</label>
						<div class="col-sm-5">
							<input type="text" placeholder="(xxx)xxxxxxx" name="phoneNo" class="form-control" value="${x.loginDto.phoneNumber}">
						</div></div>
						
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-ta">Address</label>
						<div class="col-sm-5">
							<textarea placeholder="Enter address" name="address" disabled="disabled" class="form-control"> ${x.address}</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Enter User Id" name="userId" class="form-control" value="${x.loginDto.username}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Password</label>
						<div class="col-sm-5">
							<input type="password" placeholder="Enter Password" name="password"	class="form-control" value="${x.loginDto.password }">
						</div>
					</div>
						<input type="hidden" value="${x.residentId}" name="residentId"/>
