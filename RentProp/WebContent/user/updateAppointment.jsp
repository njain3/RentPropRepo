...
<%-- 	<c:forEach items="${sessionScope.apartments_address }" var="y"> --%>
			<div>
			<h4 align="left">Change Appointment Schedule for Apartment Address: ${sessionScope.apartmentAddress.address}, ${sessionScope.apartmentAddress.city  }, ${sessionScope.apartmentAddress.state  }</h4>
			</div>
			<br>
			<div class="panel-body">
				
				<form class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/appointmentServlet?flag=update" method="post" role="form">
					<input type="hidden" name="appointment_id" value="${sessionScope.viewAppointment.appointmentId} }">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							First Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter First Name" name="firstname" class="form-control" value="${sessionScope.viewAppointment.firstname}">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Last Name</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Last Name" name="lastname" class="form-control" value="${sessionScope.viewAppointment.lastname}">
						</div></div>
						<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id*</label>
						<div class="col-sm-5">
							<input type="email" placeholder="abc@gmail.com"  required name="email" class="form-control" value="${sessionScope.viewAppointment.emailid }">
						</div></div>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.</label>
						<div class="col-sm-5">
							<input type="text" placeholder="(xxx)xxxxxxx" name="phone" class="form-control" value="${sessionScope.viewAppointment.phoneno}">
						</div></div>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-ta">Address</label>
							<div class="col-sm-5">
							<textarea placeholder="Enter full address" name="address" class="form-control" >${sessionScope.apartmentAddress.address}</textarea>
							</div>
						</div>
						<div class="form-group">
