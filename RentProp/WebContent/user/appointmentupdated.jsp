...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<div class="main-content">
			<h4 align="left">Appointment Updated for Apartment Address: ${sessionScope.apartmentAddress.address}, ${sessionScope.apartmentAddress.city }, ${sessionScope.apartmentAddress.state }</h4>
