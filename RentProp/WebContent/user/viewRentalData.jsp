...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<c:forEach items="${sessionScope.rental_data }" var="x">
			
			
			<h4 align="left">Your Rental Request</h4>
			<%-- <h2 align="center"></h2> --%>
			...
			<div class="form-group">
					...
					<div class="form-group">
						...
						<label class="col-sm-3 control-label" for="field-1">
							Email Id</label>
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">${x.emailId}</label>
						</div></div><br>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.</label>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-ta">Status</label>
							<div class="col-sm-5">
							<label class="col-sm-3 control-label" for="field-ta">${x.status}</label>
						  	</div>
						</div><br>
						
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-ta">Property Address</label>
							<div class="col-sm-5">
			...
			<label class="col-sm-3 control-label" for="field-ta" ><font color="red">Please note down your Rental Request Id.</font></label> 
