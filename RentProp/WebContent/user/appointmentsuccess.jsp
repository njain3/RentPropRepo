...
<link rel="icon"
	href="http://demo.neontheme.com/assets/img/favicon.ico">
...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<div class="main-content">
			...
			<h4 align="left">Appointment Confirmed for Apartment Address: ${sessionScope.apartmentAddress.address}, ${sessionScope.apartmentAddress.city }, ${sessionScope.apartmentAddress.state }</h4>
			<%-- <h2 align="center"></h2> --%>
			...
			<div class="form-group">
						...
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">
							${sessionScope.viewAppointment.appointmentId}</label>
						</div></div><br>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							First Name</label>
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">
							${sessionScope.viewAppointment.firstname}</label>
						</div></div><br>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Last Name</label>
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">
							${sessionScope.viewAppointment.lastname}</label>							
						</div></div><br>
						<div class="form-group">						
						<label class="col-sm-3 control-label" for="field-1">
							Email Id</label>
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">${sessionScope.viewAppointment.emailid}</label>
						</div></div><br>
						<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Phone No.</label>
						<div class="col-sm-5">
						<label class="col-sm-3 control-label" for="field-1">
							${sessionScope.viewAppointment.phoneno}</label>
						</div></div><br>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-ta">Address</label>
							<div class="col-sm-5">
							<label class="col-sm-3 control-label" for="field-ta">${sessionScope.viewAppointment.address}</label>
							</div>
						</div><br><br>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
							<label class="col-sm-3 control-label" for="field-ta">${sessionScope.viewAppointment.date}</label>
						  	</div>
						</div><br>
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-ta">Time Slot</label> 
							<div class="col-sm-5">
							<label class="col-sm-3 control-label" for="field-ta">${sessionScope.viewAppointment.slot}</label>
							</div>
						</div>
			</div>
