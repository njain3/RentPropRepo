        ...
        <div class="row">
            <div class="col-md-12">
                <div class="signin-signup-form">
                    <a href="../user/index.jsp"><img src="img/logo_rentprop_new.png" height="75" width="285"/></a>
                    <div class="form-title"><br>LOGIN</div>
                    <form action="<%=request.getContextPath() %>/loginServlet" method="post">
                        <input type="hidden" name="flag" value="login" required>
                        <div class="form-text">
                            <input type="text" name="username" placeholder="Username" required value="pm">
                        </div>
                        <div class="form-text">
                            <input type="password" name="password" placeholder="Password" required value="pm">
                        </div>
