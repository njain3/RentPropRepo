		...
		<section>
				<div class="container">
					...
					<div class="row" id="inner-contact-address">
						<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div class="row" align="center">
								<div class="inner-contact-border">
									<p>1400, Washington Ave</p>
									<p>Albany, NY - 12222</p>
									<p>United States.</p>
									<p>Phone : (518) - 000 - 0000</p>
									<p>Email : rentpropmgr@gmail.com</p>									
								</div>
					...
					<div class="inner-contact-agent-area">
								...
								<div class="row">
									...
									<div class="col-md-10 col-sm-10 col-xs-9">
										...
										<div class="inner-contact-icon">
											<span class="glyphicon glyphicon-earphone"></span><span>518-000-0000</span>
											<span class="glyphicon glyphicon-envelope"></span><span><a href="mailto:rentpropmgr@gmail.com">rentpropmgr@gmail.com</a></span>
										</div>
									</div>
								</div>
							</div>
						...
						<form method="post" action="<%=request.getContextPath() %>/contactUsServlet?flag=add">
							<div class="row">
								<div class="col-md-6 col-sm-6 col-xs-12">
