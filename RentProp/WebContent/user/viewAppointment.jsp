...
out.print("<p style='background-color:red; font-size:24px; color:white'><b>"+error +"</b></p>");
		...
		<div class="main-content">
			...
			<div>
			<h2 align="center"><br>View an Appointment</h2></div>
			<br>
			<div class="panel-body">
				<form name="appointform" class="form-horizontal form-groups-bordered" action="<%=request.getContextPath()%>/appointmentServlet" method="post" role="form">
					<input type="hidden" name="flag" id="flag"/>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Appointment Id</label>
						<div class="col-sm-5">
							<input type="text" placeholder="Enter Appointment Id" name="appointmentid" class="form-control">
						</div></div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="field-1">
							Email Id</label>
						<div class="col-sm-5">
							<input type="email" placeholder="Enter Email Id" name="emailid" class="form-control">
						</div></div>
						
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<input type="button" class="btn btn-primary" value="View Appointment" onclick="_submit('view')"/>
							<input type="button" class="btn btn-primary" value="Change Appointment" onclick="_submit('fetch')"/>
							<input type="button" class="btn btn-primary" value="Cancel Appointment" onclick="_submit('delete')"/>
	...
	<script>
		function _submit(flag) {
			var hiddenSelectedOp = document.getElementById("flag");
	        hiddenSelectedOp.value = flag;
